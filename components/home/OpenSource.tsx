    ...
    <section className="bg-black py-20 px-4 sm:px-6 lg:px-8 border-t border-zinc-900/60 relative">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-2">
              <Link
                ...
                target="_blank"
                className="inline-flex h-10 items-center justify-center gap-2 rounded-md border border-zinc-800 bg-zinc-950 px-6 text-xs font-bold text-zinc-300 hover:text-white hover:border-zinc-700 transition-colors"
              >
          ...
          <div className="rounded-xl border border-zinc-900 bg-zinc-950/40 p-6 flex flex-col justify-between hover:border-zinc-800 transition-all duration-300 relative overflow-hidden group min-h-[200px]">
            {/* Glow background */}
            <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-emerald-500/5 blur-[80px] pointer-events-none" />

            <div className="flex items-center justify-between border-b border-zinc-900/80 pb-4 mb-4 select-none">
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div className="flex justify-between items-end h-20 w-full px-2 mb-4 select-none">
                ...
                <svg className="w-full h-full text-emerald-500/30 group-hover:text-emerald-500/50 transition-colors duration-500" viewBox="0 0 200 60" fill="none">
                  {/* Grid Lines */}
