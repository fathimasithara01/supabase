...
import { ShieldCheck, Server, History, Globe2, HelpCircle } from "lucide-react";
  ...
  return (
    <section className="bg-[#030303] py-20 px-4 sm:px-6 lg:px-8 border-b border-zinc-900">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="rounded-xl border border-zinc-800 bg-[#070708] p-6 sm:p-8 mb-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            {/* Visual Column */}
            <div className="lg:col-span-5 rounded-lg border border-zinc-850 bg-zinc-950 p-6 flex flex-col items-center">
              ...
              <div className="flex items-center justify-between w-full border-b border-zinc-900 pb-4 mb-6">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors outline-none cursor-pointer ${
                    spendCapOn ? "bg-emerald-500" : "bg-zinc-850 border border-zinc-800"
                  }`}
                >
                  <span
              ...
              <div className="w-full flex flex-col gap-2">
                <div className="flex justify-between text-[10px] text-zinc-500 font-bold uppercase">
                  ...
                  <span className={spendCapOn ? "text-emerald-400" : "text-amber-400"}>
                    {spendCapOn ? "Capped at $25" : "Pay As You Go"}
                  </span>
                </div>
                
                {/* Bar indicators */}
                <div className="h-24 w-full flex items-end justify-between gap-2 border-b border-zinc-850 pb-1 mt-2">
                  <div className="w-full bg-emerald-500 h-[30%] rounded-t transition-all duration-300" />
                  <div className="w-full bg-emerald-500 h-[45%] rounded-t transition-all duration-300" />
                  <div className="w-full bg-emerald-500 h-[65%] rounded-t transition-all duration-300" />
                  <div className="w-full h-[85%] rounded-t transition-all duration-500 overflow-hidden bg-zinc-900 relative">
                    <div
                      className={`absolute bottom-0 w-full rounded-t transition-all duration-500 ${
                        spendCapOn ? "bg-emerald-500 h-[70%]" : "bg-emerald-500 h-[100%]"
                      }`}
                    />
                    {spendCapOn && (
            ...
            <div className="lg:col-span-7 space-y-4">
              <span className="inline-block rounded-full bg-emerald-500/10 border border-emerald-500/30 px-2.5 py-0.5 text-[9px] font-bold text-emerald-400 uppercase tracking-wide">
              ...
              <div className="rounded border border-zinc-850 bg-zinc-950/40 p-3 text-xs flex gap-2">
                <ShieldCheck className="h-4 w-4 text-emerald-400 shrink-0 mt-0.5" />
                <div>
                  <span className="font-semibold text-white">Current status: </span>
                  <span className={spendCapOn ? "text-emerald-400 font-semibold" : "text-amber-400 font-semibold"}>
                    {spendCapOn 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Custom Domain */}
          <div className="rounded-xl border border-zinc-800 bg-[#070708] p-6 hover:border-zinc-700 transition-all flex flex-col justify-between">
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-zinc-500 mt-0.5">custom.domain.com</div>
                </div>
              </div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-[#070708] p-6 hover:border-zinc-700 transition-all flex flex-col justify-between">
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">Point in Time Recovery</h4>
                  <div className="text-[10px] text-zinc-500 mt-0.5">Database back-ups</div>
                </div>
              </div>
              <div className="text-right">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              Roll back your database to any specific point in time, down to the second, for peace of mind.
            </p>
          </div>
